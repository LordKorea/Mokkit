...
package io.gitlab.lordkorea.mokkit.entity.vehicle.minecart;
...
public class MokkitRideableMinecart extends MokkitMinecart implements RideableMinecart {
     ...
     */
    public MokkitRideableMinecart(final @NonNull MokkitServer server, final @NonNull Location location,
